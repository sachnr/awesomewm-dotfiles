...
awful.keyboard.append_global_keybindings({
	awful.key({ modkey, "Shift" }, "j", function()
		awful.client.swap.bydirection("down", client.focused)
	end, { description = "swap by direction down", group = "client" }),

	awful.key({ modkey, "Shift" }, "k", function()
		awful.client.swap.bydirection("up", client.focused)
	end, { description = "swap by direction up", group = "client" }),

	awful.key({ modkey, "Shift" }, "h", function()
		awful.client.swap.bydirection("left", client.focused)
	end, { description = "swap by direction left", group = "client" }),

	awful.key({ modkey, "Shift" }, "l", function()
		awful.client.swap.bydirection("right", client.focused)
	...
	end, { description = "Resize by direction up", group = "client" }),

	awful.key({ modkey, "Control" }, "j", function()
		awful.client.incwfact(0.05)
	end, { description = "Resize by direction down", group = "client" }),

	awful.key({ modkey, "Control" }, "h", function()
		awful.tag.incmwfact(-0.05)
	end, { description = "Resize by direction left", group = "client" }),

	awful.key({ modkey, "Control" }, "l", function()
		awful.tag.incmwfact(0.05)
	end, { description = "Resize by direction right", group = "client" }),
})
...
awful.keyboard.append_global_keybindings({
	...
	awful.key({}, "XF86AudioLowerVolume", function()
		require("bar.modules.volume.wireplumber").decVol(5)
	end, { description = "volume down", group = "hotkeys" }),
	awful.key({}, "XF86AudioRaiseVolume", function()
		require("bar.modules.volume.wireplumber").incVol(5)
